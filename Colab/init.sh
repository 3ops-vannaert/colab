...
until error=$(sshfs -o reconnect,ServerAliveInterval=15,ServerAliveCountMax=3,UserKnownHostsFile=/dev/null,StrictHostKeyChecking=no colab@$1:/upload -p ${2:-2222} /content/ssh 2>&1 >/dev/null); do
